...
-- =========================================================
insert into products (id, category_id, name, slug, short_description, base_price, status, featured, badge, sort_order) values
  ('b0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000001', 'Buy AWS 512vCPU Account', '512-vcpu', 'High-capacity AWS account for large, demanding workloads.', 290.00, 'active', true, 'Popular', 1),
  ('b0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000001', 'Buy AWS 256vCPU Account', '256-vcpu', 'High-capacity AWS account for heavy compute workloads.', 180.00, 'active', true, null, 2),
  ('b0000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000001', 'Buy AWS 128 vCPU Account', '128-vcpu', 'Mid-to-high tier AWS account for scaling workloads.', 110.00, 'active', false, null, 3),
  ('b0000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000001', 'Buy AWS 64 vCPU Account', '64-vcpu', 'Balanced AWS account for general-purpose workloads.', 70.00, 'active', false, null, 4),
  ('b0000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000001', 'Buy AWS 32 vCPU Account', '32-vcpu', 'AWS account available in multiple configuration tiers.', 38.00, 'active', true, 'Multiple Configurations', 5),
  ('b0000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000001', 'Buy AWS 8 vCPU Account', '8-vcpu', 'Entry-level AWS account available in multiple configuration tiers.', 20.00, 'active', false, 'Multiple Configurations', 6),
  ('b0000000-0000-4000-8000-000000000007', 'a0000000-0000-4000-8000-000000000001', 'Buy AWS Free Trial Account', 'free-trial', 'Free trial AWS account to evaluate before purchasing.', 15.00, 'active', false, null, 7)
on conflict (id) do nothing;
...
-- =========================================================
insert into products (id, category_id, name, slug, short_description, base_price, status, featured, badge, sort_order) values
  ('c0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000002', 'Buy AWS Account — 10 RPM | 32 vCPU | Gmail | N. Virginia | 2FA + API', '10-rpm-32-vcpu', 'AWS AI account with 10 RPM, 32 vCPU, Gmail login, and N. Virginia region.', 70.00, 'active', true, null, 1),
  ('c0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000002', 'Buy AWS Account — 50 RPM | Kiro Working | 32 vCPU | Gmail | 2FA + API', '50-rpm-kiro-32-vcpu', 'AWS AI account with 50 RPM, Kiro-working status, 32 vCPU, and Gmail login.', 220.00, 'active', true, null, 2),
  ('c0000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000002', 'Buy AWS Account — 10K RPM | 4.6 Support | 5 vCPU | Multi-Year Aged', '10k-rpm-5-vcpu-aged', 'Multi-year aged AWS AI account with 10K RPM, 5 vCPU, and 4.6-rated support.', 220.00, 'active', false, 'Aged', 3),
  ('c0000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000002', 'Buy AWS Account — 10K RPM | 4.6 Support | 96 vCPU | Multi-Year Aged', '10k-rpm-96-vcpu-aged', 'Multi-year aged AWS AI account with 10K RPM, 96 vCPU, and 4.6-rated support.', 350.00, 'active', false, 'Aged', 4),
  ('c0000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000002', 'Buy AWS Account — 10K RPM | 4.6 Support | 128 vCPU | Multi-Year Aged', '10k-rpm-128-vcpu-aged', 'Multi-year aged AWS AI account with 10K RPM, 128 vCPU, and 4.6-rated support.', 850.00, 'active', false, 'Aged', 5),
  ('c0000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000002', 'Buy AWS Account — 10K RPM | 4.6 Support | 256 vCPU | Multi-Year Aged', '10k-rpm-256-vcpu-aged', 'Multi-year aged AWS AI account with 10K RPM, 256 vCPU, and 4.6-rated support.', 900.00, 'active', true, 'Aged', 6)
on conflict (id) do nothing;
...
-- =========================================================
insert into products (id, category_id, name, slug, short_description, base_price, status, featured, sort_order) values
  ('d0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000003', 'Buy AWS 1k Credit Account', '1k-credit', 'AWS account pre-loaded with $1,000 of promotional credit.', 240.00, 'active', true, 1),
  ('d0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000003', 'Buy AWS 5k Credit Account', '5k-credit', 'AWS account pre-loaded with $5,000 of promotional credit.', 1199.00, 'active', true, 2),
  ('d0000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000003', 'Buy AWS 10k Credit Account', '10k-credit', 'AWS account pre-loaded with $10,000 of promotional credit.', 2399.00, 'active', true, 3),
  ('d0000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000003', 'Buy AWS 25k Credit Account', '25k-credit', 'AWS account pre-loaded with $25,000 of promotional credit.', 4999.00, 'active', false, 4),
  ('d0000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000003', 'Buy AWS 50k Credit Account', '50k-credit', 'AWS account pre-loaded with $50,000 of promotional credit.', 7499.00, 'active', false, 5),
  ('d0000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000003', 'Buy AWS 100k Credit Account', '100k-credit', 'AWS account pre-loaded with $100,000 of promotional credit.', 12999.00, 'active', false, 6)
on conflict (id) do nothing;
