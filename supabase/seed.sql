...
-- =========================================================
insert into products (id, category_id, provider, name, slug, product_slug, short_description, base_price, status, featured, badge, sort_order) values
  ('b0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000001', 'AWS', 'Buy AWS 512vCPU Account', '512-vcpu', 'Buy-AWS-512vCPU-Account', 'High-capacity AWS account for large, demanding workloads.', 290.00, 'active', true, 'Popular', 1),
  ('b0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000001', 'AWS', 'Buy AWS 256vCPU Account', '256-vcpu', 'Buy-AWS-256vCPU-Account', 'High-capacity AWS account for heavy compute workloads.', 180.00, 'active', true, null, 2),
  ('b0000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000001', 'AWS', 'Buy AWS 128 vCPU Account', '128-vcpu', 'Buy-AWS-128-vCPU-Account', 'Mid-to-high tier AWS account for scaling workloads.', 110.00, 'active', false, null, 3),
  ('b0000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000001', 'AWS', 'Buy AWS 64 vCPU Account', '64-vcpu', 'Buy-AWS-64-vCPU-Account', 'Balanced AWS account for general-purpose workloads.', 70.00, 'active', false, null, 4),
  ('b0000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000001', 'AWS', 'Buy AWS 32 vCPU Account', '32-vcpu', 'Buy-AWS-32-vCPU-Account', 'AWS account available in multiple configuration tiers.', 38.00, 'active', true, 'Multiple Configurations', 5),
  ('b0000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000001', 'AWS', 'Buy AWS 8 vCPU Account', '8-vcpu', 'Buy-AWS-8-vCPU-Account', 'Entry-level AWS account available in multiple configuration tiers.', 20.00, 'active', false, 'Multiple Configurations', 6),
  ('b0000000-0000-4000-8000-000000000007', 'a0000000-0000-4000-8000-000000000001', 'AWS', 'Buy AWS Free Trial Account', 'free-trial', 'Buy-AWS-Free-Trial-Account', 'Free trial AWS account to evaluate before purchasing.', 15.00, 'active', false, null, 7)
on conflict (id) do nothing;
...
-- =========================================================
insert into products (id, category_id, provider, name, slug, product_slug, short_description, base_price, status, featured, badge, sort_order) values
  ('c0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000002', 'AWS', 'Buy AWS Account — 10 RPM | 32 vCPU | Gmail | N. Virginia | 2FA + API', '10-rpm-32-vcpu', 'Buy-AWS-Account-10-RPM-32-vCPU-Gmail-N-Virginia-2FA-API', 'AWS AI account with 10 RPM, 32 vCPU, Gmail login, and N. Virginia region.', 70.00, 'active', true, null, 1),
  ('c0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000002', 'AWS', 'Buy AWS Account — 50 RPM | Kiro Working | 32 vCPU | Gmail | 2FA + API', '50-rpm-kiro-32-vcpu', 'Buy-AWS-Account-50-RPM-Kiro-Working-32-vCPU-Gmail-2FA-API', 'AWS AI account with 50 RPM, Kiro-working status, 32 vCPU, and Gmail login.', 220.00, 'active', true, null, 2),
  ('c0000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000002', 'AWS', 'Buy AWS Account — 10K RPM | 4.6 Support | 5 vCPU | Multi-Year Aged', '10k-rpm-5-vcpu-aged', 'Buy-AWS-Account-10K-RPM-46-Support-5-vCPU-Multi-Year-Aged', 'Multi-year aged AWS AI account with 10K RPM, 5 vCPU, and 4.6-rated support.', 220.00, 'active', false, 'Aged', 3),
  ('c0000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000002', 'AWS', 'Buy AWS Account — 10K RPM | 4.6 Support | 96 vCPU | Multi-Year Aged', '10k-rpm-96-vcpu-aged', 'Buy-AWS-Account-10K-RPM-46-Support-96-vCPU-Multi-Year-Aged', 'Multi-year aged AWS AI account with 10K RPM, 96 vCPU, and 4.6-rated support.', 350.00, 'active', false, 'Aged', 4),
  ('c0000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000002', 'AWS', 'Buy AWS Account — 10K RPM | 4.6 Support | 128 vCPU | Multi-Year Aged', '10k-rpm-128-vcpu-aged', 'Buy-AWS-Account-10K-RPM-46-Support-128-vCPU-Multi-Year-Aged', 'Multi-year aged AWS AI account with 10K RPM, 128 vCPU, and 4.6-rated support.', 850.00, 'active', false, 'Aged', 5),
  ('c0000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000002', 'AWS', 'Buy AWS Account — 10K RPM | 4.6 Support | 256 vCPU | Multi-Year Aged', '10k-rpm-256-vcpu-aged', 'Buy-AWS-Account-10K-RPM-46-Support-256-vCPU-Multi-Year-Aged', 'Multi-year aged AWS AI account with 10K RPM, 256 vCPU, and 4.6-rated support.', 900.00, 'active', true, 'Aged', 6)
on conflict (id) do nothing;
...
-- =========================================================
insert into products (id, category_id, provider, name, slug, product_slug, short_description, base_price, status, featured, sort_order) values
  ('d0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000003', 'AWS', 'Buy AWS 1k Credit Account', '1k-credit', 'Buy-AWS-1k-Credit-Account', 'AWS account pre-loaded with $1,000 of promotional credit.', 240.00, 'active', true, 1),
  ('d0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000003', 'AWS', 'Buy AWS 5k Credit Account', '5k-credit', 'Buy-AWS-5k-Credit-Account', 'AWS account pre-loaded with $5,000 of promotional credit.', 1199.00, 'active', true, 2),
  ('d0000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000003', 'AWS', 'Buy AWS 10k Credit Account', '10k-credit', 'Buy-AWS-10k-Credit-Account', 'AWS account pre-loaded with $10,000 of promotional credit.', 2399.00, 'active', true, 3),
  ('d0000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000003', 'AWS', 'Buy AWS 25k Credit Account', '25k-credit', 'Buy-AWS-25k-Credit-Account', 'AWS account pre-loaded with $25,000 of promotional credit.', 4999.00, 'active', false, 4),
  ('d0000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000003', 'AWS', 'Buy AWS 50k Credit Account', '50k-credit', 'Buy-AWS-50k-Credit-Account', 'AWS account pre-loaded with $50,000 of promotional credit.', 7499.00, 'active', false, 5),
  ('d0000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000003', 'AWS', 'Buy AWS 100k Credit Account', '100k-credit', 'Buy-AWS-100k-Credit-Account', 'AWS account pre-loaded with $100,000 of promotional credit.', 12999.00, 'active', false, 6)
on conflict (id) do nothing;
...
-- =========================================================
insert into products (id, category_id, provider, name, slug, product_slug, short_description, base_price, status, featured, badge, sort_order) values
  ('20000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000004', 'OVHCloud', 'Buy OVHCloud Account', 'ovhcloud-account', 'Buy-OVHCloud-Account', 'OVHCloud account available in multiple configuration tiers.', 35.00, 'active', false, 'Multiple Variants', 1),
  ('20000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000004', 'IBM Cloud', 'Buy IBM Cloud Account', 'ibm-cloud-account', 'Buy-IBM-Cloud-Account', 'Standard IBM Cloud account, ready to use.', 40.00, 'active', false, null, 2),
  ('20000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000004', 'iCloud', 'Buy Verified iCloud Account', 'verified-icloud-account', 'Buy-Verified-iCloud-Account', 'Verified iCloud account available in multiple configuration tiers.', 25.00, 'active', false, 'Multiple Variants', 3),
  ('20000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000004', 'Alibaba Cloud', 'Buy Alibaba Cloud Account', 'alibaba-cloud-account', 'Buy-Alibaba-Cloud-Account', 'Alibaba Cloud account available in multiple configuration tiers.', 60.00, 'active', false, 'Multiple Variants', 4),
  ('20000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000004', 'UpCloud', 'Buy UpCloud Account', 'upcloud-account', 'Buy-UpCloud-Account', 'Standard UpCloud account, ready to use.', 30.00, 'active', false, null, 5),
  ('20000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000004', 'Kamatera', 'Buy Kamatera Account', 'kamatera-account', 'Buy-Kamatera-Account', 'Kamatera account available in multiple configuration tiers.', 25.00, 'active', false, 'Multiple Variants', 6),
  ('20000000-0000-4000-8000-000000000007', 'a0000000-0000-4000-8000-000000000004', 'Oracle Cloud', 'Buy Oracle Cloud Account', 'oracle-cloud-account', 'Buy-Oracle-Cloud-Account', 'Oracle Cloud account available in multiple configuration tiers.', 40.00, 'active', false, 'Multiple Variants', 7),
  ('20000000-0000-4000-8000-000000000008', 'a0000000-0000-4000-8000-000000000004', 'Google Cloud', 'Buy Google Cloud Account', 'google-cloud-account', 'Buy-Google-Cloud-Account', 'Google Cloud account available in multiple configuration tiers.', 80.00, 'active', true, 'Multiple Variants', 8),
  ('20000000-0000-4000-8000-000000000009', 'a0000000-0000-4000-8000-000000000004', 'Linode', 'Buy Linode Account', 'linode-account', 'Buy-Linode-Account', 'Linode account available in multiple configuration tiers.', 25.00, 'active', false, 'Multiple Variants', 9),
  ('20000000-0000-4000-8000-000000000010', 'a0000000-0000-4000-8000-000000000004', 'Vultr', 'Buy Vultr Account', 'vultr-account', 'Buy-Vultr-Account', 'Vultr account available in multiple configuration tiers.', 30.00, 'active', true, 'Multiple Variants', 10),
  ('20000000-0000-4000-8000-000000000011', 'a0000000-0000-4000-8000-000000000004', 'Hetzner', 'Buy Hetzner Account', 'hetzner-account', 'Buy-Hetzner-Account', 'Hetzner account available in multiple configuration tiers.', 40.00, 'active', false, 'Multiple Variants', 11),
  ('20000000-0000-4000-8000-000000000012', 'a0000000-0000-4000-8000-000000000004', 'DigitalOcean', 'Buy Digital Ocean Account', 'digital-ocean-account', 'Buy-Digital-Ocean-Account', 'DigitalOcean account available in multiple configuration tiers.', 20.00, 'active', true, 'Multiple Variants', 12),
  ('20000000-0000-4000-8000-000000000013', 'a0000000-0000-4000-8000-000000000004', 'Azure', 'Buy Azure Accounts', 'azure-accounts', 'Buy-Azure-Accounts', 'Azure account available in multiple configuration tiers.', 20.00, 'active', true, 'Multiple Variants', 13)
on conflict (id) do nothing;
...
-- =========================================================
-- product_slug values below end in "-2" — these 19 rows deliberately mirror
-- the same product titles already used by AWS Accounts / AWS AI Accounts /
-- AWS Credit Accounts above (see comment at the top of this section), so a
-- title-derived slug alone would collide. Disambiguated the same
-- deterministic way the app does (src/lib/data/fixtures/index.ts): the
-- first product to claim a slug keeps it clean, later duplicates get "-2".
insert into products (id, category_id, provider, name, slug, product_slug, short_description, base_price, status, featured, badge, sort_order) values
  ('40000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS 512vCPU Account', '512-vcpu-account', 'Buy-AWS-512vCPU-Account-2', 'High-capacity Amazon AWS account for large, demanding workloads.', 290.00, 'active', true, null, 1),
  ('40000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS 256vCPU Account', '256-vcpu-account', 'Buy-AWS-256vCPU-Account-2', 'High-capacity Amazon AWS account for heavy compute workloads.', 180.00, 'active', true, null, 2),
  ('40000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS 128 vCPU Account', '128-vcpu-account', 'Buy-AWS-128-vCPU-Account-2', 'Mid-to-high tier Amazon AWS account for scaling workloads.', 110.00, 'active', false, null, 3),
  ('40000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS 64 vCPU Account', '64-vcpu-account', 'Buy-AWS-64-vCPU-Account-2', 'Balanced Amazon AWS account for general-purpose workloads.', 70.00, 'active', false, null, 4),
  ('40000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS 32 vCPU Account', '32-vcpu-account', 'Buy-AWS-32-vCPU-Account-2', 'Amazon AWS account available in multiple configuration tiers.', 38.00, 'active', true, 'Multiple Variants', 5),
  ('40000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS 8 vCPU Account', '8-vcpu-account', 'Buy-AWS-8-vCPU-Account-2', 'Entry-level Amazon AWS account available in multiple configuration tiers.', 20.00, 'active', false, 'Multiple Variants', 6),
  ('40000000-0000-4000-8000-000000000007', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS Free Trial Account', 'free-trial-account', 'Buy-AWS-Free-Trial-Account-2', 'Free trial Amazon AWS account to evaluate before purchasing.', 15.00, 'active', false, null, 7),
  ('40000000-0000-4000-8000-000000000008', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS 1k Credit Account', '1k-credit-account', 'Buy-AWS-1k-Credit-Account-2', 'Amazon AWS account pre-loaded with 1,000 of promotional credit.', 240.00, 'active', true, null, 8),
  ('40000000-0000-4000-8000-000000000009', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS 5k Credit Account', '5k-credit-account', 'Buy-AWS-5k-Credit-Account-2', 'Amazon AWS account pre-loaded with 5,000 of promotional credit.', 1199.00, 'active', true, null, 9),
  ('40000000-0000-4000-8000-000000000010', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS 10k Credit Account', '10k-credit-account', 'Buy-AWS-10k-Credit-Account-2', 'Amazon AWS account pre-loaded with 10,000 of promotional credit.', 2399.00, 'active', true, null, 10),
  ('40000000-0000-4000-8000-000000000011', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS 25k Credit Account', '25k-credit-account', 'Buy-AWS-25k-Credit-Account-2', 'Amazon AWS account pre-loaded with 25,000 of promotional credit.', 4999.00, 'active', false, null, 11),
  ('40000000-0000-4000-8000-000000000012', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS 50k Credit Account', '50k-credit-account', 'Buy-AWS-50k-Credit-Account-2', 'Amazon AWS account pre-loaded with 50,000 of promotional credit.', 7499.00, 'active', false, null, 12),
  ('40000000-0000-4000-8000-000000000013', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS 100k Credit Account', '100k-credit-account', 'Buy-AWS-100k-Credit-Account-2', 'Amazon AWS account pre-loaded with 100,000 of promotional credit.', 12999.00, 'active', false, null, 13),
  ('40000000-0000-4000-8000-000000000014', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS Account — 10 RPM | 32 vCPU | Gmail | N. Virginia | 2FA + API', '10-rpm-32-vcpu-account', 'Buy-AWS-Account-10-RPM-32-vCPU-Gmail-N-Virginia-2FA-API-2', 'Amazon AWS account with 10 RPM, 32 vCPU, Gmail login, and N. Virginia region.', 70.00, 'active', true, null, 14),
  ('40000000-0000-4000-8000-000000000015', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS Account — 50 RPM | Kiro Working | 32 vCPU | Gmail | 2FA + API', '50-rpm-kiro-32-vcpu-account', 'Buy-AWS-Account-50-RPM-Kiro-Working-32-vCPU-Gmail-2FA-API-2', 'Amazon AWS account with 50 RPM, Kiro-working status, 32 vCPU, and Gmail login.', 220.00, 'active', true, null, 15),
  ('40000000-0000-4000-8000-000000000016', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS Account — 10K RPM | 4.6 Support | 5 vCPU | Multi-Year Aged', '10k-rpm-5-vcpu-aged-account', 'Buy-AWS-Account-10K-RPM-46-Support-5-vCPU-Multi-Year-Aged-2', 'Multi-year aged Amazon AWS account with 10K RPM, 5 vCPU, and 4.6-rated support.', 220.00, 'active', false, 'Aged', 16),
  ('40000000-0000-4000-8000-000000000017', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS Account — 10K RPM | 4.6 Support | 96 vCPU | Multi-Year Aged', '10k-rpm-96-vcpu-aged-account', 'Buy-AWS-Account-10K-RPM-46-Support-96-vCPU-Multi-Year-Aged-2', 'Multi-year aged Amazon AWS account with 10K RPM, 96 vCPU, and 4.6-rated support.', 350.00, 'active', false, 'Aged', 17),
  ('40000000-0000-4000-8000-000000000018', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS Account — 10K RPM | 4.6 Support | 128 vCPU | Multi-Year Aged', '10k-rpm-128-vcpu-aged-account', 'Buy-AWS-Account-10K-RPM-46-Support-128-vCPU-Multi-Year-Aged-2', 'Multi-year aged Amazon AWS account with 10K RPM, 128 vCPU, and 4.6-rated support.', 850.00, 'active', false, 'Aged', 18),
  ('40000000-0000-4000-8000-000000000019', 'a0000000-0000-4000-8000-000000000005', 'Amazon AWS', 'Buy AWS Account — 10K RPM | 4.6 Support | 256 vCPU | Multi-Year Aged', '10k-rpm-256-vcpu-aged-account', 'Buy-AWS-Account-10K-RPM-46-Support-256-vCPU-Multi-Year-Aged-2', 'Multi-year aged Amazon AWS account with 10K RPM, 256 vCPU, and 4.6-rated support.', 900.00, 'active', true, 'Aged', 19)
on conflict (id) do nothing;
