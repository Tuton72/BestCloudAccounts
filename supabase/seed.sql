...
-- =========================================================
insert into products (id, category_id, name, slug, short_description, base_price, status, featured, badge, sort_order) values
  ('c0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000002', 'Buy AWS Account — 10 RPM | 32 vCPU | Gmail | N. Virginia | 2FA + API', '10-rpm-32-vcpu', 'AWS account configured for AI workloads with API access.', 70.00, 'active', true, null, 1),
  ('c0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000002', 'Buy AWS Account — 50 RPM | Kiro Working | 32 vCPU | Gmail | 2FA + API', '50-rpm-kiro-32-vcpu', 'AWS account configured for AI workloads with API access.', 220.00, 'active', true, null, 2),
  ('c0000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000002', 'Buy AWS Account — 10K RPM | 4.6 Support | 5 vCPU | Multi-Year Aged', '10k-rpm-5-vcpu-aged', 'Multi-year aged AWS account configured for AI workloads.', 220.00, 'active', false, 'Aged', 3),
  ('c0000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000002', 'Buy AWS Account — 10K RPM | 4.6 Support | 96 vCPU | Multi-Year Aged', '10k-rpm-96-vcpu-aged', 'Multi-year aged AWS account configured for AI workloads.', 350.00, 'active', false, 'Aged', 4),
  ('c0000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000002', 'Buy AWS Account — 10K RPM | 4.6 Support | 128 vCPU | Multi-Year Aged', '10k-rpm-128-vcpu-aged', 'Multi-year aged AWS account configured for AI workloads.', 850.00, 'active', false, 'Aged', 5),
  ('c0000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000002', 'Buy AWS Account — 10K RPM | 4.6 Support | 256 vCPU | Multi-Year Aged', '10k-rpm-256-vcpu-aged', 'Multi-year aged AWS account configured for AI workloads.', 900.00, 'active', true, 'Aged', 6)
on conflict (id) do nothing;
