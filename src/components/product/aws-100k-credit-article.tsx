...
import {
  ...
  whyChooseCards,
  whyChooseUsCards,
} from "@/config/content/aws-100k-credit-article";

/**
 * Full AWS 100k Credit article, shown below the existing product detail
 ...
 * paragraphs/cards.
 */
export function Aws100kCreditArticle() {
  return (
    <div className="py-16 sm:py-20">
      <Container className="flex flex-col gap-16 sm:gap-20">
        ...
        {/* AWS 100k Credit vs Official AWS Activate — two-column comparison,
        ...
        <div className="mx-auto max-w-[1160px]">
          <div className="mx-auto max-w-[880px]">
            ...
            <p className="mt-4 leading-relaxed text-ink-secondary">{comparisonSection.intro}</p>
          </div>
        ...
        <Faq items={articleFaq} eyebrow="FAQ" heading="Frequently Asked Questions About Buying AWS 100k Credit Accounts" align="left" />

        {/* Why Choose BestCloudAccounts — exactly 10 cards, incl. Global Availability */}
      ...
      <div className="mt-16 sm:mt-20">
        <FinalCTA
          heading="Buy an AWS 100k Credit Account Today"
          description="Start building on the cloud today with $100,000 in AWS credit at zero upfront cost — 100% verified accounts with instant delivery and optimized vCPU limits."
