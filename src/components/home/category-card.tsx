...
export function CategoryCard({ category, productCount }: CategoryCardProps) {
  ...
  return (
    ...
    >
      <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-accent/20 via-accent-cyan/20 to-accent-violet/20 text-accent-cyan">
