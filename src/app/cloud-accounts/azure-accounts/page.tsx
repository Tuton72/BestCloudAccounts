 ...
 * This lets the Azure page carry extra long-form content without touching
 * the generic ProductDetail route used by the other Cloud Account
 * products.
 */
  ...
  return (
    <div>
      ...
      <ContactPrompt
        ...
        description="Have questions about Azure accounts, free credits, services, subscriptions, virtual machines, AI workloads, or account specifications? Our team is available to help you choose the appropriate option."
      />
      <AzureArticle />
    </div>
  );
