...
export default function Aws64VcpuAccountPage() {
  return (
    <div>
      ...
      <ContactPrompt
        heading="Need Help Choosing an AWS 64 vCPU Account?"
        description="Have questions about 64 vCPU limits, AWS regions, credits, AI workloads, enterprise workloads, packages, or choosing the right AWS account? Our team is available to help you choose the appropriate option."
      />
      <Aws64VcpuArticle />
    </div>
  );
