...
export const AWS_AI_ACCOUNTS: ProductSeed[] = [
  {
    ...
    slug: "10-rpm-32-vcpu",
    shortDescription: "AWS AI account with 10 RPM, 32 vCPU, Gmail login, and N. Virginia region.",
    basePrice: 70,
    status: "active",
    featured: true,
    badge: null,
  ...
  },
  {
    ...
    shortDescription: "AWS AI account with 50 RPM, Kiro-working status, 32 vCPU, and Gmail login.",
    basePrice: 220,
    status: "active",
    featured: true,
    badge: null,
  ...
  },
  {
    ...
    shortDescription: "Multi-year aged AWS AI account with 10K RPM, 5 vCPU, and 4.6-rated support.",
    basePrice: 220,
    status: "active",
    featured: false,
    badge: "Aged",
  ...
  },
  {
    ...
    shortDescription: "Multi-year aged AWS AI account with 10K RPM, 96 vCPU, and 4.6-rated support.",
    basePrice: 350,
    status: "active",
    featured: false,
    badge: "Aged",
  ...
  },
  {
    ...
    shortDescription: "Multi-year aged AWS AI account with 10K RPM, 128 vCPU, and 4.6-rated support.",
    basePrice: 850,
    status: "active",
    featured: false,
    badge: "Aged",
  ...
  },
  {
    ...
    shortDescription: "Multi-year aged AWS AI account with 10K RPM, 256 vCPU, and 4.6-rated support.",
    basePrice: 900,
    status: "active",
    featured: true,
    badge: "Aged",
